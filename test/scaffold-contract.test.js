...
test('ships timer, project, and calendar workflows in one keyboard panel', () => {
  ...
  assert.match(widget, /uiRevision:\s*"optimistic-ui-v1"/)
  assert.match(widget, /Model\.formatTimerLabel/)
  assert.match(widget, /selectedContentRole:/)
  assert.match(panel, /var message = root\.timeTracking && root\.timeTracking\.activeTimer/)
  ...
  assert.match(panel, /iconSpinning:\s*root\.pendingIntent === "pause"/)
  assert.match(panel, /Refreshing FreshBooks/)
})
